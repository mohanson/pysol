...
def test_fail():
    ...
    for _ in range(8):
        ...
        with pytest.raises(AssertionError):
            assert sol.eddsa.verify(pubkey, msg, sig)


def test_pt():
    for _ in range(8):
        k = sol.ed25519.Fr(random.randint(1, sol.ed25519.N - 1))
        p = sol.ed25519.G * k
        assert p == sol.eddsa.pt_decode(sol.eddsa.pt_encode(p))
